...
int WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd) {
	...
	// Create Window
	HWND window = CreateWindow(window_class.lpszClassName, L"TheBigSnake", WS_OVERLAPPEDWINDOW | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT, 1280, 720, 0, 0, hInstance, 0);
	/*{
		//Fullscreen
...
input.buttons[b].is_down=is_down;\
				...
				switch (vk_code)
				{
					...
					process_button(BUTTON_ENTER, 13);
				}
